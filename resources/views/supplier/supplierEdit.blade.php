...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        @endif
        <div class="container">
        <form action="{{route('supplierUpdate',['id'=>$id->id])}}" method="POST" enctype="multipart/form-data">
            <h3> <i class="fas fa-shipping-fast    "></i> Edit Data Supplier {{$id->nama}}</h3>
            <hr>
            {{csrf_field()}}
            @method('patch')
              <div class="row">
                  ...
                  <div class="col-6">
                      ...
                      <input value="{{$id->keterangan}}" name="keterangan" type="text" class="form-control bg-light"
                          id="keterangan">
                  </div>
              </div>
              <hr>
